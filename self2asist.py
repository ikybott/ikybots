...
acil = PRANKBOTS.LINE() 
acil.login(token="EugLoPfgFVO8juHeKlE8.MZT+twxnJqv5lbwzVBCMYa.CeOP/9uf8UqN1QF+t3i1eD+5oFz0zX5CO1kZ6e7oWow=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="Eu3KecWbM2ohBZkQ17T7.zd4e3aK8zStpaUqDSmpODW.gTCNEMe0qYGlTBq121hw8K5k/BOWewnY5WS0LW0ZuBc=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="EuDr1GwqLylEutH6B6Ta.bAaNzi+wULIrRrIqkPcH/G.6LRiiPnudPk3JG4xXe7ap14atBH4ZogZbi4LiIhKZ/w=")
pb2.loginResult()
...
admsa = "u9b3b7f4d65cd8d05792c1599bdb726c8"
...
#--------------------------------------------------------
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    acil.sendText(msg.to,"BOT Sudah Keluar Di semua grup")
                else:
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Dor","Mention","Crot","Tag"]:
                group = acil.getGroup(msg.to)
